...
packages <- c("tidyverse","rio","jmv","ggplot2","readr")
```
...
-   List each variable and the level of measurement. Note if there are
    ...
    -   height – continuous (ratio), no issues noted
    -   weight - continuous(ratio), no issues noted
...
``` r
# an earlier command imported the dataset. I opened it in a new window so I can keep it open and viewable while transforming. 
jmv::descriptives(dataset, vars = vars(LOSS_total,FOSS_total), freq=FALSE, box=TRUE)
```
    ...
    ##  Descriptives                                       
    ##  ────────────────────────────────────────────────── 
    ##                          LOSS_total    FOSS_total   
    ##  ────────────────────────────────────────────────── 
    ##    N                             96            96   
    ##    Missing                        0             0   
    ##    Mean                    11.90625      8.208333   
    ##    Median                  12.00000      8.000000   
    ##    Standard deviation      2.567317      2.401388   
    ##    Minimum                 6.000000      3.000000   
    ##    Maximum                 18.00000      14.00000   
    ##  ──────────────────────────────────────────────────

![](Week03DataManipulationAssignment_files/figure-markdown_github/unnamed-chunk-10-1.png)![](Week03DataManipulationAssignment_files/figure-markdown_github/unnamed-chunk-10-2.png)
...
-   How do the z-scores compare between the sum scores and the mean
    ...
    -   Answer: LOSS_total & LOSS_mean, and FOSS_total & FOSS_mean are
        the same.
...
-   What does it mean if a z-score is positive or negative?
    ...
    -   positive: standard deviations above the mean
    -   negative: standard deviations below the mean
